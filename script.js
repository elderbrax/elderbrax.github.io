...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const startMessage = "click around — something interesting awaits";
  ...
  const bioMessages = [
    "｡˚○ bubbles",
    "𓃮 ankylosaurus on top",
    "𓋼𓍊 \“a sigma is as a sigma does“\ - mahatma gandhi",
    "๑ï the game... ",
    "ৎ୭ always taking L's",
    "𐃯 7.3k"
  ];
  let bioText = '';
  let bioIndex = 0;
